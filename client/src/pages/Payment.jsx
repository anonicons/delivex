  ...
  return (
    <div className='payment '>
      ...
      <div style={{minWidth:"300px"}} className="mx-auto shadow-max bg-white p-3" >
        ...
        <div>
        <p className='text-blacked p-1  text-secondary'> <span className='fw-bold text-black'>Note:</span>  Availabilty of payment methods is determined by the type of the shipment and the package shipped. This is to ensure save and secured shipment process. </p>
        </div>
       ...
       <span>bank</span>
       <br />
       <button className='btn btn-warning btn-md mt-2'>Proceed with bank methods</button>
       <div className='text-end text-blacked'>
           - disabled
        </div>
       </div>
