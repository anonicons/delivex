  ...
  return (
    <div className='product-details d-flex flex-column align-items-center justify-content-center fonta' >
        <div className='d-flex flex-column align-items-center justify-content-center'>
            <span className='fw-bold text-success'>Package is already on location</span> <button className='btn btn-warning btn-sm my-3 fw-bold' onClick={() => navigate('/payment')}> {">>>"} Proceed to clear your package </button>
        </div>
